...
$\textbf{Theorem 1.1}$ Any preference relation that can be represented by a continuous utility function is rational. To be more specific, only rational preferences relations can be represented by a utility
function; conversely, if $X$ is finite, any rational preference relation can be represented by a utility function.
